...
function Feed() {
	return (
		<>
			<div className="p-5 max-w-lg border-solid border-2 shadow-md  rounded-lg ml-auto mr-auto ">
				<div className="flex">
				...
				<div className="w-full">comment posted by other users</div>
				<div>date posted</div>
				<div className="pt-3">
					...
					<div className="mt-1 relative rounded-md shadow-sm">
						...
						<input type="text" name="comment" id="comment" className="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-7 pr-12 sm:text-sm border-gray-500 rounded-md h-8" placeholder="comment" />
					</div>
				</div>
			</div>
		</>
